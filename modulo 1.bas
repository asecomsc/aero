...
Set Fm = Forms("Impresion Etiquetas")
        ...
        Print #1, "^FT642,836^A0B,39,38^FH\^FD" & Format(Val(Fm.pesoNeto), "0.000") & "^FS" 'peso bruto, err confundí neto con bruto
        ...
        Print #1, "^FD>;" & Format(Fm.cbModelo, "000") & Format(Fm.cbColor, "000") & Format(Val(miNeto * 100), "0000") & Fm.teñido & "^FS"
